...
const styles = StyleSheet.create({
  ...
  heroName: { fontFamily: 'Fraunces_700Bold', fontSize: 34, color: colors.white, lineHeight: 36, letterSpacing: -0.3 },
  ...
  expEmptyTitle: { fontFamily: 'Fraunces_600SemiBold', fontSize: 22, color: colors.text },
