...
const styles = StyleSheet.create({
  ...
  heroActionBtnText: { fontFamily: 'PlusJakartaSans_500Medium', fontSize: 12, color: colors.white },
  heroLoc: { fontFamily: 'PlusJakartaSans_500Medium', fontSize: 11, color: 'rgba(180,215,240,0.85)', letterSpacing: 1.2, marginBottom: 4 },
  heroName: { fontFamily: 'PlusJakartaSans_800ExtraBold', fontSize: 34, color: colors.white, lineHeight: 36, letterSpacing: -0.3 },
  heroDates: { fontFamily: 'PlusJakartaSans_400Regular', fontSize: 12, color: 'rgba(180,200,230,0.8)', marginTop: 6 },
  ...
  budgetAmt: { fontFamily: 'PlusJakartaSans_600SemiBold', fontSize: 22, color: colors.text },
  budgetCur: { fontFamily: 'PlusJakartaSans_400Regular', fontSize: 14, color: colors.muted },
  budgetLabel: { fontFamily: 'PlusJakartaSans_400Regular', fontSize: 13, color: colors.muted },
  ...
  debtTitle: { fontFamily: 'PlusJakartaSans_600SemiBold', fontSize: 13, color: colors.text },
  settleBtn: { backgroundColor: colors.sunsetSoft, borderRadius: 100, paddingVertical: 4, paddingHorizontal: 12 },
  settleBtnText: { fontFamily: 'PlusJakartaSans_500Medium', fontSize: 12, color: colors.sunset },
  ...
  debtAvatarText: { fontFamily: 'PlusJakartaSans_600SemiBold', fontSize: 10, color: colors.white },
  debtText: { flex: 1, fontFamily: 'PlusJakartaSans_400Regular', fontSize: 13, color: colors.text },
  debtName: { fontFamily: 'PlusJakartaSans_600SemiBold', color: colors.text },
  debtAmt: { fontFamily: 'PlusJakartaSans_600SemiBold', fontSize: 13, color: colors.sunset },
  debtMore: { fontFamily: 'PlusJakartaSans_500Medium', fontSize: 12, color: colors.ocean, marginTop: 8, textAlign: 'center' },
  allClear: { backgroundColor: colors.forestSoft, borderRadius: 16, padding: 14, marginHorizontal: 16, alignItems: 'center' },
  allClearText: { fontFamily: 'PlusJakartaSans_500Medium', fontSize: 14, color: colors.forest },
  ...
  memberAvatarText: { fontFamily: 'PlusJakartaSans_600SemiBold', fontSize: 10, color: colors.white },
  memberText: { flex: 1, fontFamily: 'PlusJakartaSans_400Regular', fontSize: 13, color: colors.muted },
  ...
  sectionBadgeText: { fontFamily: 'PlusJakartaSans_500Medium', fontSize: 12, color: colors.muted },
  expEmpty: { alignItems: 'center', paddingVertical: 40, marginHorizontal: 16 },
  expEmptyEmoji: { fontSize: 40, marginBottom: 10 },
  expEmptyTitle: { fontFamily: 'PlusJakartaSans_800ExtraBold', fontSize: 22, color: colors.text },
  expEmptySub: { fontFamily: 'PlusJakartaSans_400Regular', fontSize: 13, color: colors.muted, marginTop: 4, textAlign: 'center' },
