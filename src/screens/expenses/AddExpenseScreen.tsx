...
const styles = StyleSheet.create({
  ...
  fieldLabel: { fontFamily: 'PlusJakartaSans_500Medium', fontSize: 13, color: colors.text },
  ...
  chipText: { fontFamily: 'PlusJakartaSans_500Medium', fontSize: 11, color: colors.text },
  chipTextActive: { color: colors.white },
  rateInfo: {
    flexDirection: 'row', alignItems: 'center', gap: 6,
    backgroundColor: colors.oceanSoft, borderRadius: 10, padding: 10,
  },
  rateText: { fontFamily: 'PlusJakartaSans_400Regular', fontSize: 12, color: colors.ocean },
  ...
  catLabel: { fontFamily: 'PlusJakartaSans_500Medium', fontSize: 10, color: colors.muted },
  catLabelActive: { color: colors.ocean },
  chargesToggle: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  chargesToggleText: { fontFamily: 'PlusJakartaSans_500Medium', fontSize: 13, color: colors.ocean },
  ...
  totalRow: { fontFamily: 'PlusJakartaSans_400Regular', fontSize: 12, color: colors.muted },
  totalFinal: { fontFamily: 'PlusJakartaSans_600SemiBold', fontSize: 14, color: colors.text },
  memberRow: {
  ...
  memberName: { fontFamily: 'PlusJakartaSans_500Medium', fontSize: 14, color: colors.text },
  ...
  splitSummaryText: { fontFamily: 'PlusJakartaSans_500Medium', fontSize: 13, color: colors.text },
  ...
  splitLabel: { fontFamily: 'PlusJakartaSans_400Regular', fontSize: 13, color: colors.muted },
  participantRow: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  splitPreview: { fontFamily: 'PlusJakartaSans_400Regular', fontSize: 12, color: colors.muted, textAlign: 'center' },
  btn: { marginTop: 8 },
})
