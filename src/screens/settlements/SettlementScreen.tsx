...
const styles = StyleSheet.create({
  ...
  debtName: { fontFamily: 'PlusJakartaSans_500Medium', fontSize: 12, color: colors.text, textAlign: 'center' },
  debtArrow: { alignItems: 'center', gap: 2, flex: 1 },
  debtAmount: { fontFamily: 'PlusJakartaSans_600SemiBold', fontSize: 18, color: colors.text },
  debtCurrency: { fontFamily: 'PlusJakartaSans_400Regular', fontSize: 11, color: colors.muted },
  settleBtn: {
    backgroundColor: colors.sunsetSoft, borderRadius: 100,
    paddingVertical: 10, alignItems: 'center',
  },
  settleBtnText: { fontFamily: 'PlusJakartaSans_600SemiBold', fontSize: 13, color: colors.sunset },
  historyRow: {
  ...
  historyInfo: { flex: 1 },
  historyText: { fontFamily: 'PlusJakartaSans_400Regular', fontSize: 13, color: colors.text },
  historyName: { fontFamily: 'PlusJakartaSans_600SemiBold' },
  historyDate: { fontFamily: 'PlusJakartaSans_400Regular', fontSize: 11, color: colors.muted, marginTop: 2 },
  historyAmt: { fontFamily: 'PlusJakartaSans_600SemiBold', fontSize: 13, color: colors.forest },
})
